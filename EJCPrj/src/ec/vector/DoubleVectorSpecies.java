...
public class DoubleVectorSpecies extends VectorSpecies
    {
    ...
    public void setup(final EvolutionState state, final Parameter base)
        ...
        for(int x=0 ; x < genomeSize + 1; x++)
            ...
            if (((mutationType[x] == DoubleVectorSpecies.C_INTEGER_RESET_MUTATION || 
                        mutationType[x] == DoubleVectorSpecies.C_INTEGER_RANDOM_WALK_MUTATION))  // integer type
